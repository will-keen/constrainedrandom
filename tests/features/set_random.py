...
class SetRandomReproducible(unittest.TestCase):
    ...
    def test_set_random_reproducible(self):
        ...
        self.assertEqual(results_a, results_b, 'Results should be identical for the same seed')

        # Different seed should produce different results
        results_c = make_and_randomize(1)
        self.assertNotEqual(results_a, results_c, 'Results should differ for different seeds')
